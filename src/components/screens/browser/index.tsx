...
import { ISafeAreaPosition, useBrowserManager, useBrowserNavigationHeight, useDimensions, useHasBezel, useOrientation, useSafeAreaPosition, } from 'src/hooks'
...
const StyledWebView = styled(WebView) <IStyledWebViewProps>`
  ...
  ${({ hasBezel, orientation, safeAreaPosition }) => `
    padding-horizontal: ${!hasBezel && orientation !== PORTRAIT ? safeAreaPosition.top : 0
    };
  `}
`
