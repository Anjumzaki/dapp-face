...
export function BrowserNavigation() {
  ...
  return (
    <Animated.View style={[styles.navigationBar, { height, opacity }]}>
      <IconButton disabled={isOpen || !canGoBack} icon='arrow-left' onPress={goBack} size={24} />
      <IconButton disabled={isOpen || !canGoForward} icon='arrow-right' onPress={goForward} size={24} />
      <IconButton disabled={isOpen} icon='plus' onPress={addTab} size={24} />
      <IconButton
